...
This library generates reports based on scientific literature queries using Scopus, Voyage AI, and X.AI Grok.
...
Ensure you have the necessary permissions and subscriptions for Scopus API, Voyage AI, and X.AI Grok.
...
```python
from report_generator import ReportingAI, set_api_keys
